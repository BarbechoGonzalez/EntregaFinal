...
/** \mainpage RoboComp::resetodometry
 *
 * \section intro_sec Introduction
 *
 * The resetodometry component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/resetodometry --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class resetodometry : public RoboComp::Application
{
public:
	resetodometry (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::resetodometry::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
